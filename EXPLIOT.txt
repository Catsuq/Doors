...
local Window = Library.CreateLib("Made by Exploit (Credit Lopvii)", "Ocean")

local Tab = Window:NewTab("The Items")

local Section = Tab:NewSection("Items")

Section:NewLabel("idk")

Section:NewButton("Ice cream", "gives ice cream in doors", function()
    local Item = game:GetObjects("rbxassetid://110887863")[1]
  Item.Parent = game.Players.LocalPlayer.Backpack
end)

Section:NewButton("Torch (gives light)", "Works, kinda useful", function()
    local Item = game:GetObjects("rbxassetid://3499523244")[1]
  Item.Parent = game.Players.LocalPlayer.Backpack
end)

Section:NewButton("Paint Bucket", "Cool i guess", function()
    local Item = game:GetObjects("rbxassetid://82578488")[1]
  Item.Parent = game.Players.LocalPlayer.Backpack
end)

Section:NewButton("Balloon (read info)", "Works if you use a jump script for doors", function()
    local Item = game:GetObjects("rbxassetid://844258278")[1]
  Item.Parent = game.Players.LocalPlayer.Backpack
end)

Section:NewButton("Burger XD", "Crabby Patty", function()
    local Item = game:GetObjects("rbxassetid://100522628")[1]
  Item.Parent = game.Players.LocalPlayer.Backpack
end)

Section:NewButton("Sword (read info)", "it's A SWORD omg!", function()
    local Item = game:GetObjects("rbxassetid://77443461 ")[1]
  Item.Parent = game.Players.LocalPlayer.Backpack
end)

local Tab = Window:NewTab("Other Scripts...")

local Section = Tab:NewSection("Epik scripts")

Section:NewButton("Plamen Gui", "This is plamen's gui (Not made by me)", function()
    print("loadstring(game:HttpGet('https://raw.githubusercontent.com/plamen6789/DoorsEntitySummonerGUI/main/EntityGUI'))()")
end)


Section:NewButton("Spongus Entity Replicator", "This is made by Spongus!", function()
...
Section:NewButton("Doors Hardcore Made By MuhammadGames", "This is made byMuhammad",function()--[=[
@class txt
...
Section:NewButton("Doors Hardcore Made By Chrono", "This is made by Chrono",function() loadstring(game:HttpGet("https://raw.githubusercontent.com/ChronoAccelerator/CometV4/main/OtherBigScripts/Him.lua",true))()
...
local SpawnEntity = Window:NewTab("Spawn Entity (Visual)")
local SpawnEntitySection = SpawnEntity:NewSection("Spawn Entity")
SpawnEntitySection:NewButton("spawn halt", "omg not fe btw", function()

          require(game.ReplicatedStorage.ClientModules.EntityModules.Shade).stuff(require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game),
workspace.CurrentRooms[game.Players.LocalPlayer:GetAttribute("CurrentRoom")])

end)
SpawnEntitySection:NewButton("spawn spider", "omg not fe btw", function()
...
SpawnEntitySection:NewButton("spawn Screech", "omg not fe btw", function()
          require(game.StarterGui.MainUI.Initiator.Main_Game.RemoteListener.Modules.Screech)(require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game),
workspace.CurrentRooms[game.Players.LocalPlayer:GetAttribute("CurrentRoom")])
end)
 
SpawnEntitySection:NewButton("spawn Glitch", "omg not fe btw", function()
          require(game.ReplicatedStorage.ClientModules.EntityModules.Glitch).stuff(require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game),
workspace.CurrentRooms[game.Players.LocalPlayer:GetAttribute("CurrentRoom")])
end)


local DoorsMoodTab = Window:NewTab("Door Mods!")
local DoorsMods = DoorsMoodTab:NewSection("Mods")
DoorsMods:NewButton("Minecraftmod", "Made by penguinmaniack", function()
loadstring(game:HttpGet("https://pastebin.com/raw/y2WmccLk"))()  
end)

DoorsMods:NewButton("Noonie hardcore", "Made by Noonie", function()
 --[[
                 _      
...
local DoorsMoodTab = Window:NewTab("Crucifixes")
local DoorsMods = DoorsMoodTab:NewSection("Crucifixes")
DoorsMods:NewButton("Crucifixes buy angry hub", "Angry Hub", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/RmdComunnityScriptsProvider/AngryHub/main/Seek%20Crucifix.lua"))()
end)

DoorsMods:NewButton("Crucifixes", "Angry Hub", function()
--[[game.ReplicatedStorage.GameData.LatestRoom.Changed:Connect(function()
           local function setup(room)
        for _, v in pairs(room:GetDescendants()) do
            if v.Name=="Stand" then]]--
local model = game:GetObjects("rbxassetid://11903931886")[1]
...
local crucifix = workspace.CurrentRooms[game.ReplicatedStorage.GameData.LatestRoom.Value].Parts.Handle
    tweenService:Create(crucifix, TweenInfo.new(1, Enum.EasingStyle.Linear), 
		{CFrame = crucifix.CFrame * CFrame.Angles(math.rad(0), math.rad(0), math.rad(-90))})
	:Play()
	wait(2)
	tweenService:Create(crucifix, TweenInfo.new(2, Enum.EasingStyle.Linear),
		{CFrame = crucifix.CFrame * CFrame.new(0,7,0)})
	:Play()
	wait(3)
		tweenService:Create(crucifix, TweenInfo.new(3, Enum.EasingStyle.Linear), 
		{CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame})
	:Play()
    wait(3)
    Crucifix:Destroy()
-- // Crucifix Things
getgenv().TheTool = "11590476113" --Example: getgenv().TheTool = 11590476113 (That is the Normal Crucifix)
getgenv().TheCircleWithTheChains = "11584227521" --Example: getgenv().TheTool = 11584227521 (That is the Normal Crucifix)
...
DoorsMods:NewButton("Random Crucifix", "Idk", function()
local Players = game:GetService("Players")
...
DoorsMods:NewButton("Crucifixes By exploit (Aka me)", "exploit hub winning!", function()

end)


local colors = {
    SchemeColor = Color3.fromRGB(255, 255, 277),
    Background = Color3.fromRGB255, 255, 277,
    Header = Color3.fromRGB(255, 255, 277),
    TextColor = Color3.fromRGB(255, 255, 277),
    ElementColor = Color3.fromRGB(255, 255, 277 ),
}

local DoorsMoodTab = Window:NewTab("Other scripts")
local DoorsMods = DoorsMoodTab:NewSection("Infinite yield")
DoorsMods:NewButton("Infinite yield", "Infinite yield", function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)



DoorsMods:NewButton("Dark dex", "Dark Dex", function()
--[[
	DEX Main Script
...
DoorsMods:NewButton("Vynixus Hub", "Vynixus Hub", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Vynixius/main/Doors/Script.lua"))()
end)


DoorsMods:NewButton("Doors AutowinFarm", "AutoWinFarm", function()
loadstring(game:HttpGet('https://pastebin.com/raw/2VQEyt1H'))()
end)

for theme, color in pairs(themes) do
    Section:NewColorPicker(theme, "Change your "..theme, Blue, function(Blue)
        Library:ChangeColor(theme, color3)
    end)
end

local Window = Library.CreateLib("Cool Ui", " BloodTheme")
